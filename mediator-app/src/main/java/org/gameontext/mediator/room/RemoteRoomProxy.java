...
import org.gameontext.mediator.MediatorBuilder.UpdateType;
...
public class RemoteRoomProxy implements RoomMediator {
     ...
     *
     * @see org.gameontext.mediator.room.RoomMediator#updateInformation(org.gameontext.mediator.models.Site)
     */
    @Override
